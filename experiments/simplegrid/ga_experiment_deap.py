...
def main():
    ...
    if args.json_dir:
        ...
        if not args.skip_ga:
            ...
            # score_spec with per-score resources (edit here if you need different CPU/GPU)
            score_spec = [
                {
                    ...
                    "params": {
                        ...
                        "eval_every": 250, "n_eval_episodes": 1,
                    },
